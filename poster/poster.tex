...
\definetitlestyle{CompactStanford}{
    width=880mm, roundedcorners=20, linewidth=0.3cm, innersep=0.8cm,
...
\block{5.~Reconstruction Quality}{
    ...
    \begin{minipage}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{rawvae_small/spectrograms_edit.png}\\
