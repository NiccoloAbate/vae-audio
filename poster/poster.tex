...
\block{2.~Architecture Overview}{
    ...
    each latent frame $\approx 11.6$\,ms of audio, preserving finer temporal structure
    than SpecVAE's single-vector latent can represent. Free bits ($\lambda = 0.25$) prevent posterior collapse.
}
