...
\block{6.~Latent Space Structure}{
    \begin{center}
        \includegraphics[width=0.6\linewidth]{rawvae_esc50/kl_per_dim.png}\\[-5mm]
        {\small\textcolor{subtletxt}{KL per latent dim (ESC-50)}}
        \vspace{3mm}

        \includegraphics[width=0.75\linewidth]{rawvae_esc50/latent_pca.png}\\[-10mm]
...
\block{9.~Conclusions \& Future Work}{
    ...
    \begin{itemize}[leftmargin=1em, noitemsep, topsep=1pt]
        ...
        \item Larger dataset + longer training time
